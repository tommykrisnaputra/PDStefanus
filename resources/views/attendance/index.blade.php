								...
								<div class="container">
												<form method="post" action={{ route('attendance.export') }}>
																...
																<div class="search-button mb20 btn-group">
																				<button class="btn btn-primary col col-md-3" data-toggle="collapse" data-target="#collapseExample"
																								...
																								<div class="row row-space">
																												<div class="search-4">
																																<div class="input-group">
																																				...
																																				<input class="input--style-1" name="full_name" type="text"
																																								value="{{ $data->full_name ?? null }}" placeholder="Masukkan nama umat">
																																</div>
																												</div>
																												<div class="search-4">
																																<div class="input-group">
																																				<label class="label">Nomor HP</label>
																																				<input class="input--style-1" name="phone" type="tel"
																																								value="{{ $data->phone ?? null }}" placeholder="Masukkan nomor HP">
																																</div>
																												</div>
																												<div class="search-4">
																																<div class="input-group">
																																				<label class="label">Wilayah</label>
																																				<input class="input--style-1" name="wilayah" type="text"
																																								value="{{ $data->wilayah ?? null }}" placeholder="Masukkan wilayah">
																																</div>
																												</div>
																												<div class="search-4">
																																<div class="input-group">
																																				<button class="btn-submit m-b-0 mt20" name="action" type="submit"
