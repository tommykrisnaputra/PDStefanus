...
) DEFAULT CHARACTER SET utf8mb4 COLLATE 'utf8mb4_unicode_ci'; ALTER TABLE
...
CREATE TABLE `failed_jobs`(
    ...
    `failed_jobs` ADD UNIQUE `failed_jobs_uuid_unique`(`uuid`);
...
CREATE TABLE `attendance`(
    ...
    `attendance` ADD INDEX `user_id`(`user_id`);
ALTER TABLE
    `attendance` ADD INDEX `event_id`(`event_id`);
CREATE TABLE `events`(
    `id` INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
    ...
    `updated_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    `updated_by` INT NULL
) DEFAULT CHARACTER SET utf8mb4 COLLATE 'utf8mb4_unicode_ci'; CREATE TABLE `tema_pd`(
    `id` INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `title` VARCHAR(255) NOT NULL,
    `date` TIMESTAMP NOT NULL,
    `media` VARCHAR(255) NULL,
    ...
    `updated_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    `updated_by` INT NULL
) DEFAULT CHARACTER SET utf8mb4 COLLATE 'utf8mb4_unicode_ci'; CREATE TABLE `login_history`(
    `id` INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `user_id` INT NOT NULL,
    ...
    `login_history` ADD INDEX `user_id`(`user_id`);
CREATE TABLE `media`(
    `id` INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `name` VARCHAR(255) NOT NULL,
    ...
    `updated_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    `updated_by` INT NULL
) DEFAULT CHARACTER SET utf8mb4 COLLATE 'utf8mb4_unicode_ci'; CREATE TABLE `roles`(
    `id` INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
    `name` VARCHAR(255) NOT NULL,
    ...
    `updated_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    `updated_by` INT NULL
) DEFAULT CHARACTER SET utf8mb4 COLLATE 'utf8mb4_unicode_ci'; CREATE TABLE `songs`(
    `id` INT NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
ALTER TABLE
    `users` ADD INDEX `role_id`(`role_id`);
ALTER TABLE
    `attendance` ADD CONSTRAINT `attendance_ibfk_1` FOREIGN KEY(`user_id`) REFERENCES `users`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE
    `attendance` ADD CONSTRAINT `attendance_ibfk_2` FOREIGN KEY(`event_id`) REFERENCES `events`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE
    `login_history` ADD CONSTRAINT `login_history_ibfk_1` FOREIGN KEY(`user_id`) REFERENCES `users`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE
    `users` ADD CONSTRAINT `users_ibfk_1` FOREIGN KEY(`role_id`) REFERENCES `roles`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
...
VALUES(
    ...
    'PD Stefanus',
    '2023-03-24',
    'Jl. Satria IV No.Blok C',
    'Kristoforus',
    'pdstefanus',
    'pdstefanus',
    '087877828233',
    'stefan_news@yahoo.com',
    '2023-03-24',
    '2023-03-24',
    '$2y$10$uuQ6hqTbGi/UnLwR.rV8EutI1mVjUYpP/u1KCXqmEb0Jz1lMKGiEq',
    true
);
...
VALUES(
    '2023-03-30',
    'Tim Pujian PD Stefanus adalah wadah untuk kalian yang punya kerinduan memuji & menyembah Tuhan lewat talenta bernyanyi & bermain musik. Latian Pujian diadakan setiap hari selasa pukul 7 malam. Yuk join kita untuk sama-sama bernyanyi & memuji Tuhan!',
    ...
    '2023-03-30',
    'PD Stefanus di adakan setiap hari kamis malam pukul 19.00 WIB',
